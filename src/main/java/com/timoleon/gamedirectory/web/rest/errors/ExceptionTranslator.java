...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.timoleon.gamedirectory.service.EmailAlreadyUsedException ||
            ex instanceof com.timoleon.gamedirectory.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.timoleon.gamedirectory.service.InvalidPasswordException
